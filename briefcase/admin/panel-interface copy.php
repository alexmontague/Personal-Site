...
//function menu_separator(){
  //global $menu;
  //$menu[26] = array('', 'read', 'separator3', '', 'wp-menu-separator');
//}
...
if(function_exists('add_object_page')) {
            add_object_page ('Page Title', 'Themes', 8,'rockableframework', 'rockableframework_options_page', '../wp-content/themes/euphoria/admin/images/rt_icon2.png', 39); }
    else {
            add_menu_page ('Page Title', $themename, 8,'edit_theme_options', 'rockableframework_options_page'); }
 $rt_page = add_submenu_page('rockableframework', $themename, 'Theme Options', 8, 'rockableframework','rockableframework_options_page'); // Default
 //$rt_news = add_submenu_page('rockableframework', $themename, 'Rockable News', 8, 'rockable_news','rockable_news_page'); // News
...
// Add framework functionaily to the head individually
	...
	add_action( 'admin_menu', 'menu_separator', 1000 );
} 
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    ...
    <div id="logo-area">
     ...
     <div id="logo-area-pt2">
       <h1><img src="<?php echo RT_DIRECTORY; ?>/admin/images/admin_logo3.png" /></h1>
      <div id="logo-mask">
      ...
      <div id="header-part2">
           <div class="whois">
              <span class="whoispt1"></span>
                  <span class="whoispt2">
                     <?php esc_html_e('Good day', 'rt')?> <?php { $user = wp_get_current_user(); $link = $user->display_name; echo apply_filters('loginout', $link); } ?>
                  </span><!--whoispt2-->
